    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form action="{{ route('auth.store') }}" class="sign-up-form" method="POST">
                    ...
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" name="username" id="username_new" placeholder="Username" />
                    </div>
                    <div class="input-field">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="{{ URL::asset('./image/family.avif') }}" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                ...
                <img src="{{ URL::asset('./image/fata.png') }}" class="image" alt="" />
            </div>
        </div>
    </div>
